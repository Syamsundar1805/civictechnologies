...
import HomeBgImage from '../../assets/clintlogos/bg_temp.png';
...
const Hero: React.FC = () => {
    ...
    const highlights = [
        {
            icon: <EngineeringIcon className="text-3xl text-[#0177B2]" />,
            value: `${counters.years}+`,
            label: "Years of Excellence"
        },
        {
            icon: <BusinessIcon className="text-3xl text-[#0177B2]" />,
            value: `${counters.projects}+`,
            label: "Major Projects Delivered"
        },
        {
            icon: <PublicIcon className="text-3xl text-[#0177B2]" />,
            value: `${counters.countries}+`,
            label: "Countries Served"
        },
        {
            icon: <HandshakeIcon className="text-3xl text-[#0177B2]" />,
                ...
                <section ref={inViewRef} className="relative min-h-screen flex items-center overflow-hidden pt-20">
                    ...
                    <div className="container mx-auto px-6 py-6 relative z-10 w-full">
                        <div className="flex flex-col items-center text-center w-full mt-[5vh] lg:mt-[8vh]">
                            ...
                            <motion.div
                                className="mt-8 md:mt-16 z-20 cursor-pointer pointer-events-auto"
                                onClick={() => {
                                    const aboutEl = document.getElementById('normal-about');
                                    if (aboutEl) {
                            ...
                            >
                                <KeyboardArrowDownIcon className="text-[#0177B2]" sx={{ fontSize: 50 }} />
                            </motion.div>
                        </div>
                    </div>
                </section>
                ...
                <section id="normal-about" className="py-10 lg:py-16 bg-white relative">
                    <div className="container mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center gap-12">
                        <div className="w-full md:w-1/2 flex flex-col justify-center text-left">
                            <h2
                                className="text-[35px] sm:text-[40px] md:text-[50px] lg:text-[65px] text-[#0177B2] leading-none mb-1 md:mb-2 plaster-regular"
                            >
                                About
                            </h2>
                            ...
                            <div>
                                <Link
                                    to="/about"
                                    className="inline-block bg-[#252525] text-white px-8 py-3 rounded-full font-bold uppercase tracking-wide text-sm md:text-base hover:bg-[#0177B2] transition-colors duration-300 shadow-lg hover:shadow-xl"
                                >
                                    Know More About Us
                                </Link>
                            </div>
                        ...
                        <div className="w-full md:w-1/2 flex justify-center mt-6 md:mt-0">
                            <div className="relative rounded-2xl overflow-hidden w-full max-w-[300px] sm:max-w-[400px] md:max-w-[500px]">
                                <div className="absolute inset-0 bg-[#0177B2]/10 z-10 mix-blend-overlay pointer-events-none"></div>
                                <img
                                    src={HeroBg}
    ...
    return (
        <section ref={containerRef} className="relative h-[300vh] bg-white">
            <div className="sticky top-0 h-screen w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center overflow-hidden pt-20 pointer-events-none">
                    <div className="container mx-auto px-6 py-6 relative z-10 w-full">
                        <div className="flex flex-col items-center text-center w-full mt-[5vh] lg:mt-[8vh]">
                            ...
                            <motion.div style={{ opacity: opacityOut, y: yOut }} className="flex flex-col items-center z-10 w-full relative pointer-events-auto">
                                <motion.h4
                ...
                >
                    <div className="container mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="w-full md:w-1/2 flex flex-col justify-center text-left">
                            <h2
                                className="text-[35px] sm:text-[40px] md:text-[50px] lg:text-[65px] text-[#0177B2] leading-none mb-2 md:mb-4 plaster-regular"
                            >
                                About
                            </h2>
